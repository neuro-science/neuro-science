function d = plt22_srconsurface4freeview_gaussian(fname, data, source_idx, vc, nFC, para)
...
% % % need <plt07_gaussian_dist>
	...
	if isempty(fname)
		fname = '/Users/wang/Documents/FreeSurfer/sy05/surf/_tmp.act';
	elseif isnumeric(fname)
		fname = ['/Users/wang/Documents/FreeSurfer/sy05/surf/_tmp', num2str(fName, '%02d'), '.act'];
	end
	...
	%% 3. compute the data
	d = plt07_gaussian_dist (vc, src, para, data);
	
	%% 4. write to file
	write_curv(fname, d, nFC);
	
	%% 5. clean up
	clear para d0 idx src;
end
