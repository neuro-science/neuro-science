...
function [data, out] = meg_raw_filter(data, srate, freqHighPass, freqLowPass, forder, infoTag, filtOnDim)

% % % rewritten 19/06/2018 by wp and add dimension choice and filter type choice
