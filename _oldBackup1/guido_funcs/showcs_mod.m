function fid = showcs_mod(data,locs,pars);
% function showcs_mod(data,locs,pars);
% % % 26/05/14 modified guido's function by wp to
% % %		1. add figure handles for printing
% % %		2. fix a bug when input locations is only 2xN
...
% % % 	 added start 6
  subplot(nplot,nplot,n*chan, 'parent', fid);
% % %		added end	
