function h=showsurface(vc,para,varargin);
...
%                                
%                    
% para.fsv    =30, dipoles are moved towards viewer. So they are always
%              visible, set fsv to zero to avoid that. 
%                    
% 
...
elseif isfield(vc,'vc_coarse') 
    ...
    error('first argument structure should be a structure with field pnt or vc_ori_model or vc_ori or vc or vc_coarse (list of surface points)')
end
...
h=showvc_prog_plain(loc,tri,myviewdir,para);
hold on;
