function [clust] = movmf_par(vectors,k,varargin)
% % % modified by wp for parallel computation
...
if (nargin == 3)
  ...
  fid = 0;
	...
	fid = fopen('~/Documents/MATLAB/log.txt', 'w');
end
fprintf(fid, '\nTIME TAG 01, @%04d-%02d-%02d %02d:%02d:%02d!\n======\n\n', round(clock));
...
perturb = 0.1;
fprintf(fid, '\nTIME TAG 02, @%04d-%02d-%02d %02d:%02d:%02d!\n======\n\n', round(clock));
for h = 1:k
...
fprintf(fid, '\nTIME TAG 03, @%04d-%02d-%02d %02d:%02d:%02d!\n======\n\n', round(clock));
...
fprintf(fid, '\nTIME TAG 04, @%04d-%02d-%02d %02d:%02d:%02d!\n======\n\n', round(clock));
...
fprintf(fid, '\nTIME TAG 05, @%04d-%02d-%02d %02d:%02d:%02d!\n======\n\n', round(clock));
...
%   display(['Iteration ',num2str(iteration)]);
  diff = abs(value - oldvalue);
	fprintf(fid, '\niteration %d with diff %f, @%04d-%02d-%02d %02d:%02d:%02d!\n======\n\n', iteration, diff, round(clock));
  iteration = iteration + 1;
  
end
fprintf(fid, '\nTIME TAG 06, @%04d-%02d-%02d %02d:%02d:%02d!\n======\n\n', round(clock));
...
fprintf(fid, '\nTIME TAG 07, @%04d-%02d-%02d %02d:%02d:%02d!\n======\n\n', round(clock));
