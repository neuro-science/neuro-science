function [c, r, pp] = meg_cluster4pac_newer (conArray, neighborDefinition, conThresh, spfThresh, ...
...
% 	end
	...
	if pp.nPools > 1
		...
		parfor ts = 1 : pp.nTestPerCluster
			...
			% % % do clustering
			[tmp1, tmp2, sz0] = insFindCluster(t1, tCon, neighborDefinition, pp.spfThresh, pp.method, fShift1);
