function [P, pats] = meg_machineNoiseProjector(data, fs, sFreqs)
% % % calculated a projector to remove the machine noise of MEG
% % % Adopted from guido's function with modification:
% % % Specified to certain frequency range
